...
from dataclasses import dataclass, field                # We import dataclass to create a configuration class
from typing import List, Optional                       # We import List and Optional for type hinting
